...
<html>
	...
	<body>
		...
		<h4>GET 요청</h4>
		<a href="./proc/result1.jsp?userid=a101">result1</a><!-- 주소 뒤 ? 파라미터 전송  -->
		<a href="./proc/result2.jsp?userid=a101&name=홍길동">result2</a><!-- 주소 뒤 ? 파라미터 전송  -->
		<a href="./proc/result3.jsp?userid=a101&name=홍길동&age=21">result3</a><!-- 주소 뒤 ? 파라미터 전송  -->
